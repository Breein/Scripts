...
gulp.task('wrap', function(){
  ...
  userScriptDir = 'Chat_upgrade_[GW]';
  ...
  userScriptHeader =
    `// ==UserScript==
// @name        Chat upgrade [GW]
// @author      гном убийца
// @description Скрипт улучшающий чат: перемещение окна в любое место, с запоминанием позиции, сохранение введенного текста.(${nowDate})
