...
gulp.task('wrap', function(){
  ...
  userScriptHeader =
    `// ==UserScript==
// @name        Do shopping faster [GW]
// @author      гном убийца
// @description Упрощенная покупка предметов с ДО. (${nowDate})
// @include     http://www.ganjawars.ru/market.php?stage=2*
// @include     http://www.ganjawars.ru/market.php?buy=1&item_id=*
