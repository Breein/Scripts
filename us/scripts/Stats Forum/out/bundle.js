...
},{"./common":1,"./dom":2,"./events":3}],8:[function(require,module,exports){
...
PackerData.prototype = {
  ...
  player: function(o){
    ...
    {id: o.id, name: o.a, status: o.b, date: o.c, forums: o.d, _ch: false} :
    {id: o.id, a: o.name, b: o.status, c: o.date, d: o.forums, _ch: o._ch};
  },
