...
gulp.task('wrap', function(){
  ...
  userScriptDir = 'Roulette_history_[GW]';
  ...
  userScriptHeader =
    `// ==UserScript==
// @name        Roulette history [GW]
// @author      гном убийца
// @description Модуль для скрипта Make a bet, сборщик выпавших чисел с сайта sidio.ru (${nowDate})
// @include     http://www.ganjawars.ru/roulette.php
// @include     http://www.ganjawars.ru/roulette.php?results=*
// @include     http://sidio.ru/rul/last.php?s=72
