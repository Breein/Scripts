...
gulp.task('wrap', function(){
  ...
  userScriptDir = 'advanced_move_to_sector_';
  ...
  userScriptHeader =
    `// ==UserScript==
// @name        Advanced move to sector [GW]
// @author      гном убийца
// @description Дополненный и улучшенный Мove2sector, во всех линках быстрого перемещения есть расчет времени пути, с учетом вашего транспорта и местонахождения, полностью измененный интерфейс таблиц статистики, их сортировка, на лету, включая сохранение ее 3-х видов, переход на объект после прибытия. (${nowDate})
