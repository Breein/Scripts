...
gulp.task('wrap', function(){
  ...
  userScriptDir = 'Get_Bank_Data_[GW]';
  userScriptName = 'Get_Bank_Data_[GW].user.js';
  userScriptVersion = '1.1';

  nowDate = new Date(new Date().getTime()).toLocaleString();
  userScriptHeader =
    `// ==UserScript==
// @name        Get Bank Data [GW]
// @author      гном убийца
// @description Получаем и отображаем информацию с банка игры. (${nowDate})
// @include     http://www.ganjawars.ru/me/?bank=true*
// @include     http://bank.ganjawars.ru/account.php?data=true
