...
gulp.task('wrap', function(){
  ...
  userScriptDir = 'Forum_watcher_[YEPE]';
  ...
  userScriptHeader =
    `// ==UserScript==
// @name        Forum watcher [YEPE]
// @author      гном убийца
// @description Наблюдатель за форумами, оповещия о новых темах. (${nowDate})
// @include     http://photos.ganjawars.ru/index.php
// @include     http://photos.ganjawars.ru/index.php?forums=true&*
// @include     http://www.excelworld.ru/forum/6?data=true
// @include     http://www.planetaexcel.ru/forum/index.php?PAGE_NAME=list&FID=7&data=true
// @include     http://www.excel-vba.ru/forum/index.php?board=7.0?data=true
